...
export default {
  ...
  methods: {
    ...
    getColumnNaIndex(children, child) {
    ...
    setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        console.warn('[Nano Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.');
  ...
  mounted() {
    ...
    const columnIndex = this.getColumnNaIndex(children, this.$el);
